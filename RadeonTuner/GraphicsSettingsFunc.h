...
namespace winrt::RadeonTuner::implementation
{
	...
	std::optional<GraphicsSettings> MainPage::GraphicsSettings_FileLoad(std::string loadPath)
	{
		try
		{
			//Open settings file
	...
	bool MainPage::GraphicsSettings_FileSave(GraphicsSettings graphicsSettings, std::string savePath)
	{
		try
		{

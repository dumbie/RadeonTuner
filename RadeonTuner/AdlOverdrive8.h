...
namespace winrt::RadeonTuner::implementation
{
	...
	bool MainPage::Adl_Overdrive8_Set_Mode(int gpuAdapterIndex)
	{
		try
		{
			...
			//Set power mode
			requestSettingList.od8SettingTable[OD8_OPTIMZED_POWER_MODE].reset = false;
			requestSettingList.od8SettingTable[OD8_OPTIMZED_POWER_MODE].requested = true;
			requestSettingList.od8SettingTable[OD8_OPTIMZED_POWER_MODE].value = OD8_OPTIMZED_POWER_MODES::Custom;
